...
//TODO remove and use the autogenerated one from swagger once available
export type ClusterCredentials = Credentials & {
  consoleUrl: string;
};

export const getClusterCredentials = (clusterID: string): AxiosPromise<ClusterCredentials> =>
